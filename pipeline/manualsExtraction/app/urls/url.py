...
from pipeline.manualsExtraction.app.schemas.schema import LinksJsonRequest, LoteRequest, ManualLinksResponse, ManualResponse
from pipeline.manualsExtraction.app.controllers.controller import processar_links_json_controller, processar_lote_controller
